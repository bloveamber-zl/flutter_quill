...
class QuillEditor extends StatefulWidget {
  ...
  final Widget Function(BuildContext, RawEditorState)? contextMenu;
...
class QuillEditorState extends State<QuillEditor>
  ...
  Widget build(BuildContext context) {
    ...
    final child = RawEditor(
      ...
      // showSelectionToolbar ? widget.contextMenu : null,
...
class _QuillEditorSelectionGestureDetectorBuilder
  ...
  void onSingleLongTapStart(LongPressStartDetails details) {
    ...
    print('delegate.selectionEnabled:${delegate.selectionEnabled}');
    if (delegate.selectionEnabled) {
      final _platform = Theme.of(_state.context).platform;
      if (false && isAppleOS(_platform)) {
        renderEditor!.selectPositionAt(
          from: details.globalPosition,
          cause: SelectionChangedCause.longPress,
        );
